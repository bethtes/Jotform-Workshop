...
JF.initialize({ apiKey: "a3e7c14c9584b8a4700447fb69418618" }); //PUT YOUR OWN KEY HERE
 
console.log("HI!")
// get form submissions from JotForm Format: (formID, callback)
JF.getFormSubmissions("223123848187056", function (response) {
...
// YOUR MAPBOX TOKEN HERE
  ...
  const map = new mapboxgl.Map({
    ...
    style: "mapbox://styles/bethtes/cl9wty6hi000914mj0tzen6yo", // Your style URL
  ...
  map.on("load", () => {
    ...
    map.addLayer(
      new MapboxLayer({
        ...
        onClick: (info) => {
          getImageGallery(
            info.object.fileUpload, info.object.describeWhat
          );
